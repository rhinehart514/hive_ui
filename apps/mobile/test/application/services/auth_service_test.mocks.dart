...
// in hive_ui/test/application/services/auth_service_test.dart.
...
import 'package:hive_ui/data/datasources/firebase_auth_datasource.dart' as _i3;
...
class MockAuthDataSource extends _i1.Mock implements _i3.AuthDataSource {
  ...
  @override
  _i4.Future<_i2.Result<String, _i5.Failure>> requestMagicLink(String? email) =>
      (super.noSuchMethod(
        Invocation.method(
          #requestMagicLink,
          [email],
  ...
  @override
  _i4.Future<_i2.Result<String, _i5.Failure>> verifyMagicLink(String? token) =>
      (super.noSuchMethod(
        Invocation.method(
          #verifyMagicLink,
          [token],
  ...
  @override
  _i4.Future<_i2.Result<void, _i5.Failure>> signOut() => (super.noSuchMethod(
        Invocation.method(
          #signOut,
          [],
        ),
