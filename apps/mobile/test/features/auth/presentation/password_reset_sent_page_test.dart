...
void main() {
      ...
      ProviderScope(
        child: MaterialApp.router(
          routerConfig: GoRouter(
            initialLocation: AppRoutes.passwordResetSent,
            routes: [
              GoRoute(
                path: AppRoutes.passwordResetSent,
                builder: (context, state) => const PasswordResetSentPage(),
              ),
              GoRoute(
  ...
  testWidgets('PasswordResetSentPage renders correctly', (WidgetTester tester) async {
  ...
  testWidgets('PasswordResetSentPage button navigates to sign in', (WidgetTester tester) async {
     await pumpPage(tester);
