...
class AppRoutes {
  ...
  static void printRoutes() {
    if (kDebugMode) {
      print('AppRoutes.landing = $landing');
      print('AppRoutes.signIn = $signIn');
      print('AppRoutes.register = $register');
    }
  }
  ...
  static const String uiComponentsTest = '/test/ui-components';
  ...
  static const String requestVerification = '/verification-request';
  static const String requestVerifiedPlus = '/verification-request/upgrade';
  ...
  // ADDED: New Onboarding/Admin Routes
  static const String verifyIdentity = '/verify-identity';
  static const String onboardingAccessPass = '/onboarding/access-pass';
  static const String onboardingCampusDna = '/onboarding/campus-dna';
  static const String adminReviewVerification = '/admin/review-verification';
  // END ADDED
