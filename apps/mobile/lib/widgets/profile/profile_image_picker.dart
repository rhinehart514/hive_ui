...
class ProfileImagePicker extends StatelessWidget {
  ...
  /// The user's account tier for displaying verification badges/effects
  ...
  Widget build(BuildContext context) {
    final isVerifiedPlus = accountTier == AccountTier.verifiedPlus;
    ...
    // Conditionally wrap with shimmer effect for Verified+
    if (isVerifiedPlus && !reduceMotion) {
      imageWidget = Shimmer.fromColors(
        baseColor: AppColors.gold.withOpacity(0.1),
        highlightColor: AppColors.gold.withOpacity(0.4),
        period: 2.seconds,
        child: imageWidget,
      );
    }
