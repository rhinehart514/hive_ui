...
class ProfileInfoOverlay extends StatelessWidget {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              if (accountTier != AccountTier.public)
                Padding(
                  padding: const EdgeInsets.only(left: 8),
                  child: _buildVerificationBadge(accountTier),
                ),
            ],
          ),
  ...
  Widget _buildVerificationBadge(AccountTier tier) {
    ...
    final IconData icon = isVerifiedPlus ? Icons.star : Icons.verified;
    final String label = isVerifiedPlus ? 'Verified+' : 'Verified';

    // Wrap in a GestureDetector to handle verification badge taps
    return GestureDetector(
      // Only allow tapping the badge if it's for Verified+
