...
class _OnboardingProfilePageState extends ConsumerState<OnboardingProfilePage>
  ...
  final String _searchQuery = ''; // For interest search
  ...
  void _showEduEmailInputDialog() {
    // Check if the user already has any type of .edu email
    if (_userEmail.toLowerCase().endsWith('.edu')) {
                      ...
                      Expanded(
                        child: ListView(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 16),
                            Text(
                              'For verified access, please provide a .edu email address. You will need to verify this email to access higher tiers.',
                              style: AppTheme.bodyMedium.copyWith(
                                color: AppColors.textSecondary,
                              ),
                            ),
                                        ...
                                        try {
                                          ...
                                          if (currentUser != null) {
                                            ...
                                            await firestore
                                                ...
                                                .update({
                                              'educationalEmail': email,
                                              'eduEmailVerified': false, // All .edu emails require verification
                                              'updatedAt':
                                                  FieldValue.serverTimestamp(),
                                            });

                                            // Send verification email for all .edu emails
                                            try {
                                              // This would need to be implemented via Firebase Functions
                                              debugPrint(
                                                  'Sending verification email to: $email');

                                              // For all .edu emails, we need verification
                                          ...
                                          if (context.mounted) {
                                            ...
                                            // All .edu emails require verification first
                                            this.setState(() {
                                              _selectedTier = AccountTier.public;
                                              _expandedTier = null;
                                            });
                                            ...
                                            // Show the verification needed dialog
                                            Future.microtask(() {
                                              _showVerificationNeededDialog();
                                            });
                                          }
