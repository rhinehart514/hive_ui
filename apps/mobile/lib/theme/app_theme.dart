  ...
  static ThemeData get darkTheme {
    return ThemeData.dark().copyWith(
      ...
      tabBarTheme: const TabBarThemeData(
        ...
        indicatorColor: AppColors.gold, // Keep gold only for the indicator
      ...
      // Sliders - with white active color instead of gold for consistency
      ...
      // Progress indicators - with white color instead of gold for consistency
      ...
      // Add animation durations as theme extension
      extensions: [
