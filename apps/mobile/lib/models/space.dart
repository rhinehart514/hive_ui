...
import 'package:hive_ui/features/spaces/domain/entities/space_entity.dart' as domain_entity;
import 'package:hive_ui/features/spaces/domain/entities/space_metrics_entity.dart' as domain_metrics;
...
class Space {
  ...
  // Static factory method to map from SpaceEntity
  static Space fromEntity(domain_entity.SpaceEntity entity) {
    // Correct mapping for metrics 
    final SpaceMetrics metrics = SpaceMetrics(
      ...
      category: SpaceCategoryConverter.fromDomain(entity.metrics.category),
      size: SpaceSizeConverter.fromDomain(entity.metrics.size),
      engagementScore: entity.metrics.engagementScore,
      isTimeSensitive: entity.metrics.isTimeSensitive,
      expiryDate: entity.metrics.expiryDate,
      connectedFriends: entity.metrics.connectedFriends,
      firstActionPrompt: entity.metrics.firstActionPrompt,
      needsIntroduction: entity.metrics.needsIntroduction,
    );
    ...
    return Space(
      ...
      spaceType: SpaceTypeConverter.fromDomain(entity.spaceType), 
...
// Helper to convert SpaceType enums
class SpaceTypeConverter {
  // Return the imported model SpaceType
  static SpaceType fromDomain(domain_entity.SpaceType domainType) { 
    switch (domainType) {
      case domain_entity.SpaceType.studentOrg:
        return SpaceType.studentOrg;
      case domain_entity.SpaceType.universityOrg:
        return SpaceType.universityOrg;
      case domain_entity.SpaceType.campusLiving:
        return SpaceType.campusLiving;
      case domain_entity.SpaceType.fraternityAndSorority:
        return SpaceType.fraternityAndSorority;
      case domain_entity.SpaceType.hiveExclusive:
        return SpaceType.hiveExclusive;
      // Handle other domain types if they exist
      case domain_entity.SpaceType.organization:
      case domain_entity.SpaceType.project:
      case domain_entity.SpaceType.event:
      case domain_entity.SpaceType.community:
      case domain_entity.SpaceType.other:
      default:
        return SpaceType.other;
    }
  }
  
  // Parameter uses imported model SpaceType
  static domain_entity.SpaceType toDomain(SpaceType modelType) { 
     switch (modelType) {
      case SpaceType.studentOrg:
        return domain_entity.SpaceType.studentOrg;
      case SpaceType.universityOrg:
        return domain_entity.SpaceType.universityOrg;
      case SpaceType.campusLiving:
        return domain_entity.SpaceType.campusLiving;
      case SpaceType.fraternityAndSorority:
        return domain_entity.SpaceType.fraternityAndSorority;
      case SpaceType.hiveExclusive:
        return domain_entity.SpaceType.hiveExclusive;
      // Handle other model types if they exist
      case SpaceType.other:
      default:
        return domain_entity.SpaceType.other;
    }
  }
}

// ADDED: Helper to convert SpaceCategory enums 
class SpaceCategoryConverter {
  static SpaceCategory fromDomain(domain_metrics.SpaceCategory domainCategory) {
    switch (domainCategory) {
      case domain_metrics.SpaceCategory.active:
        return SpaceCategory.active;
      case domain_metrics.SpaceCategory.expanding:
        return SpaceCategory.expanding;
      case domain_metrics.SpaceCategory.emerging:
        return SpaceCategory.emerging;
      case domain_metrics.SpaceCategory.suggested:
      default:
        return SpaceCategory.suggested;
    }
  }
  
  static domain_metrics.SpaceCategory toDomain(SpaceCategory modelCategory) {
    switch (modelCategory) {
      case SpaceCategory.active:
        return domain_metrics.SpaceCategory.active;
      case SpaceCategory.expanding:
        return domain_metrics.SpaceCategory.expanding;
      case SpaceCategory.emerging:
        return domain_metrics.SpaceCategory.emerging;
      case SpaceCategory.suggested:
      default:
        return domain_metrics.SpaceCategory.suggested;
    }
  }
}

// ADDED: Helper to convert SpaceSize enums
class SpaceSizeConverter {
  static SpaceSize fromDomain(domain_metrics.SpaceSize domainSize) {
    switch (domainSize) {
      case domain_metrics.SpaceSize.large:
        return SpaceSize.large;
      case domain_metrics.SpaceSize.medium:
        return SpaceSize.medium;
      case domain_metrics.SpaceSize.small:
      default:
        return SpaceSize.small;
    }
  }
  
  static domain_metrics.SpaceSize toDomain(SpaceSize modelSize) {
     switch (modelSize) {
      case SpaceSize.large:
        return domain_metrics.SpaceSize.large;
      case SpaceSize.medium:
        return domain_metrics.SpaceSize.medium;
      case SpaceSize.small:
      default:
        return domain_metrics.SpaceSize.small;
    }
  }
}
