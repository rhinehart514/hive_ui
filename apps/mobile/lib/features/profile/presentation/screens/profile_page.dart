...
class _ProfilePageState extends ConsumerState<ProfilePage> {
            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: ProfileHeader(
                  ...
                  accountTier: viewedProfile.accountTier,
                  onImageFromCamera: (_) {},
              ...
              title: !_isHeaderExpanded
                ? Row(
                    children: [
                      ...
                      if (!isCurrentUser)
                        if (viewedProfile.accountTier != AccountTier.public)
                          Padding(
                            padding: const EdgeInsets.only(left: 6.0),
                            child: Icon(
                              viewedProfile.accountTier == AccountTier.verifiedPlus 
                                ? Icons.star 
                                : Icons.verified,
                              color: viewedProfile.accountTier == AccountTier.verifiedPlus 
                                ? AppColors.gold 
                                : AppColors.info,
                              size: 16,
                            ),
  ...
  // Update the _handleProfileOption method
  void _handleProfileOption(BuildContext context, String option, UserProfile profile) {
    switch (option) {
      case 'edit':
        ...
        break;
      case 'verify':
        // Navigate to verification request page
        context.push(AppRoutes.requestVerification);
        break;
      case 'verifyPlus':
        // Navigate to verified+ request page (upgrade path)
        context.push(AppRoutes.requestVerifiedPlus);
        break;
      case 'settings':
