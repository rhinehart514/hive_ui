...
class _AccountTierOption extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(bottom: OnboardingLayout.spacingMD),
      child: Material(
        ...
        child: InkWell(
          ...
          child: AnimatedContainer(
            ...
            padding: const EdgeInsets.all(OnboardingLayout.spacingMD),
              ...
              children: [
                ...
                if (!isSelected)
                  Row(
                    ...
                    children: [
                      _buildTierIcon(tier),
                      const SizedBox(width: OnboardingLayout.spacingXS),
                      Text(
