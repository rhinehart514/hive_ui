...
class _PlaceholderAuthRepository implements AuthRepository {
  ...
  Future<bool> verifyEmailCode(String code) async {
    throw _getMissingFirebaseException('verifyEmailCode');
  }

  @override
  Future<void> applyActionCode(String code) async {
    throw _getMissingFirebaseException('applyActionCode');
  }

  Exception _getMissingFirebaseException(String methodName) {
    return Exception('Firebase not yet initialized. Cannot call $methodName. Wait for app to finish initializing.');
  }
  
  // --- Magic Link Methods ---
  @override
  Future<bool> sendSignInLinkToEmail(String email) async {
    throw _getMissingFirebaseException('sendSignInLinkToEmail');
  }

  @override
  Future<bool> isSignInWithEmailLink(String link) async {
    throw _getMissingFirebaseException('isSignInWithEmailLink');
  }

  @override
  Future<User?> signInWithEmailLink(String email, String link) async {
    throw _getMissingFirebaseException('signInWithEmailLink');
  }

  // Add missing passkey methods
  @override
  ...
  Future<AuthUser> registerWithPasskey(String email) async {
    throw _getMissingFirebaseException('registerWithPasskey');
  }
  
  @override
  Future<AuthUser> signInWithPasskey() async {
    throw _getMissingFirebaseException('signInWithPasskey');
  }
}
...
class AuthController extends StateNotifier<AsyncValue<void>> {
  ...
  Future<bool> isPasskeySupported() async {
    try {
      return await _authRepository.isPasskeySupported();
    } catch (e, stack) {
      state = AsyncValue.error(e, stack);
      return false;
    }
  ...
  Future<void> registerWithPasskey(String email) async {
    state = const AsyncValue.loading();
    try {
      await _authRepository.registerWithPasskey(email);
      state = const AsyncValue.data(null);
    } catch (e, stack) {
      state = AsyncValue.error(e, stack);
      rethrow;
