...
class OnboardingLayout {
  ...
  static final Color primarySurface = Colors.black; // Pure black background like sign-in
  static final Color secondarySurface = Color(0xFF1E1E1E); // Match sign-in text field background
  static final Color deepLayer = Colors.black; // Pure Black
  static final Color textPrimary = Colors.white; // For primary text content
  static final Color textSecondary = Colors.white70; // Match create account subtitle
  static final Color textTertiary = Colors.white54; // For tertiary information
  static final Color textDisabled = Colors.white38; // For disabled elements
  
  // Selection indicators matching sign-in/create account gold accent theme
  static final Color activeIndicator = AppColors.gold; // Gold for active/focused elements
