...
class ResidencePage extends StatelessWidget {
  ...
  final List<String> filteredResidences;
  ...
  const ResidencePage({
    ...
    required this.filteredResidences,
        ...
        children: [
          ...
          Expanded(
            child: AnimatedSwitcher(
              ...
              child: ListView.builder(
                key: ValueKey<int>(filteredResidences.length),
                itemCount: filteredResidences.length,
                itemBuilder: (context, index) {
                  final residence = filteredResidences[index];
                  final isSelected = residence == selectedResidence;
                  
                  // Apply staggered delay based on index
                  final staggeredDelay = Duration(milliseconds: 25 * index);
          ...
          TweenAnimationBuilder<double>(
            ...
            child: AnimatedContinueButton(
              isEnabled: selectedResidence != null,
  ...
  Widget _buildResidenceItem(String residence, bool isSelected) {
    return GestureDetector(
      onTap: () => onResidenceSelected(residence),
