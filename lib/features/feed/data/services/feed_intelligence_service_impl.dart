  ...
  Future<Either<FeedFailure, List<Map<String, dynamic>>>> applyFeedIntelligence(
    ...
    try {
      ...
      if (trailResult.isLeft) {
        return Either.left(
          FeedFailureUnknown(message: 'Failed to get user trail')
        );
      }
      ...
      if (paramsResult.isLeft) {
        return Either.left(
          FeedFailureUnknown(message: 'Failed to get intelligence parameters')
        );
      }
      ...
      if (scoredResult.isLeft) {
        return Either.left(
          FeedFailureUnknown(message: 'Failed to score feed items')
        );
      }
      ...
      if (diverseResult.isLeft) {
        return Either.left(
          FeedFailureUnknown(message: 'Failed to apply diversity injection')
        );
      }
